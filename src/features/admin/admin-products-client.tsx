          ...
          >
            ...
            >
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <button
                  type="submit"
                  className="min-h-10 rounded-lg px-4 text-sm font-medium text-white"
                  style={{ backgroundColor: C.accent }}
                >
                  Create
                </button>
      ...
      {editProduct ? (
        <Modal onClose={() => setEditingId(null)} title="Edit product">
          ...
          <form action={deleteProductAction} className="mt-3">
            ...
            <button
              type="submit"
              className="min-h-10 w-full rounded-lg px-4 text-sm font-medium text-white"
  ...
  return (
    ...
    >
      ...
      <Field
        ...
        defaultValue={product?.delivery_speed ?? "~5-30 min"}
      />
...
function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 backdrop-blur-sm">
      <div
        className="w-full max-w-2xl rounded-xl border bg-white p-6 shadow-lg max-h-[90vh] overflow-y-auto"
        style={{ borderColor: C.cardBorder }}
      >
