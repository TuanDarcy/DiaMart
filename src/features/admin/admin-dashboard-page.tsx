...
function Field({
  ...
  return (
    <label className="grid gap-1">
      ...
      <input
        className="min-h-10 rounded-lg border px-3 text-sm outline-none transition-all focus:ring-2"
        style={{
...
function TextareaField({
  ...
  return (
    <label className="grid gap-1">
      ...
      <textarea
        className="rounded-lg border px-3 py-2 text-sm outline-none transition-all focus:ring-2"
        style={{
          borderColor: C.cardBorder,
          backgroundColor: "#fff",
          color: C.textPrimary,
...
function Btn({
  ...
  return (
    <button
      className="inline-flex min-h-10 items-center justify-center gap-2 rounded-lg px-4 text-sm font-medium transition-all hover:opacity-90"
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: C.bodyBg }}>
      ...
      <div className="pl-64">
        {/* Top bar */}
        <header
          className="sticky top-0 z-30 flex items-center justify-between border-b bg-white px-8 py-4"
        ...
        <main className="space-y-6 p-8">
          ...
          >
            <MetricCard
              ...
              sublabel={`${data.games.length} active`}
            />
            <MetricCard
              label="Categories"
                ...
                {[
                  {
                    label: "Manage Games",
                    target: "games",
                    desc: `${data.games.length} games`,
                  },
                  {
                    label: "Manage Products",
                    target: "products",
                    desc: `${data.products.length} products`,
                  },
                  {
                    label: "Upload Images",
                    target: "images",
          ...
          <CrudSection id="images" title="Image tools">
            <p className="mb-4 text-sm" style={{ color: C.textSecondary }}>
              Upload images to Supabase Storage or paste a public URL directly
              into the image_src field.
            </p>
            <form
            ...
            {uploadedUrl ? (
              ...
              >
                ...
                <p className="mt-1 break-all" style={{ color: C.accent }}>
                  {uploadedUrl}
                </p>
              </div>
            ) : null}
          ...
          <CrudSection id="games" title="Games">
            ...
            >
              ...
              <div className="md:col-span-3">
                <Btn type="submit">Create game</Btn>
              </div>
            </form>
            <div className="space-y-3">
              {data.games.map((game) => (
                <form
                  ...
                  style={{ borderColor: C.cardBorder, backgroundColor: "#fff" }}
                >
          ...
          <CrudSection id="products" title="Products">
            ...
            >
              ...
              <div className="md:col-span-3">
                <Btn type="submit">Create product</Btn>
              </div>
            </form>
            <div className="space-y-3">
                ...
                >
                  <div className="grid gap-3 md:grid-cols-3">
                    ...
                    <Field
                      name="image_src"
                      label="image_src"
                      defaultValue={prod.image_src}
                    />
                    <Field
                      name="image_alt"
                      label="image_alt"
                      defaultValue={prod.image_alt}
                    />
                    <Field
                      name="price_usd"
                      label="price_usd"
                      type="number"
                      defaultValue={prod.price_usd}
                    />
                    <Field
                      name="original_price_usd"
                      label="orig. price"
                      type="number"
                      defaultValue={prod.original_price_usd}
                    />
                    <Field
                      name="stock_status"
                      label="stock_status"
                      defaultValue={prod.stock_status}
                    />
                    <Field
                      name="stock_quantity"
                      label="stock_qty"
                    ...
                    <Field
                      name="delivery_speed"
                      label="delivery_speed"
                      defaultValue={prod.delivery_speed}
                    />
                    <Field
                      name="badge"
                      label="badge"
                    ...
                    >
                      <input
                        type="checkbox"
                        name="best_seller"
                        defaultChecked={prod.best_seller}
                      />{" "}
                      best seller
                    </label>
                    <div className="md:col-span-3">
          ...
          <CrudSection id="faqs" title="FAQs">
            ...
            >
              ...
              <div className="md:col-span-3">
                <Btn type="submit">Create FAQ</Btn>
              </div>
            </form>
            <div className="space-y-3">
              {data.faqs.map((faq) => (
          ...
          <CrudSection id="support-topics" title="Support topics">
            ...
            >
              ...
              <ActiveSelect defaultValue />
              <div className="md:col-span-3">
                <TextareaField name="response" label="response" />
              </div>
              <div className="md:col-span-3">
                <Btn type="submit">Create topic</Btn>
              </div>
            </form>
            <div className="space-y-3">
