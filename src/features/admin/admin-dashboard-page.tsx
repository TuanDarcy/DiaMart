        ...
        <div className="grid gap-4">
          ...
          <article className="surface-panel rounded-[20px] p-5" id="images">
            ...
            <p className="mt-2 text-sm text-slate-300">
              You can upload images to Supabase Storage or paste a CDN/public
              URL directly into the image_src field for games and products.
            </p>
            <form
          ...
          <section className="grid gap-6">
            ...
            <article
              className="surface-panel rounded-[20px] p-5"
              id="categories"
            >
