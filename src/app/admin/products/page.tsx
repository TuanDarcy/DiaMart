...
import { getAdminProducts, getAdminCategories, getAdminGames } from "@/services/admin/admin-dashboard-service";
...
export default async function AdminProductsPage() {
  ...
  return (
    <main className="p-8">
      <AdminProductsClient products={products} categories={categories} games={games} />
    </main>
  );
}
